...
export function NewPostFab(): React.ReactElement {
  return (
    <NewPostDialog.Trigger
      render={(props) => (
        <div className="pointer-events-none sticky inset-x-0 bottom-[calc(var(--spacing-height-bottom-navigation)+env(safe-area-inset-bottom)+16px)] z-10 tablet:bottom-4">
