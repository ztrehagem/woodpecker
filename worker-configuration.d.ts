/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d5db5f4c15f9cc7e33bb440c79522745)
// Runtime types generated with workerd@1.20250424.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV_SESSION: KVNamespace;
		KV_OAUTH_STATE: KVNamespace;
		KV_OAUTH_SESSION: KVNamespace;
		ATP_OAUTH_JWK_1: string;
		ATP_OAUTH_JWK_2: string;
		ATP_OAUTH_JWK_3: string;
		ORIGIN: string;
		ATP_OAUTH_CLIENT: DurableObjectNamespace<import("./src/worker/index").AtpOAuthClient>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ATP_OAUTH_JWK_1" | "ATP_OAUTH_JWK_2" | "ATP_OAUTH_JWK_3" | "ORIGIN">> {}
}
